...
```
vendor/bin/phpunit tests/unit/Espo/Modules/CustomAclLogicPoc
```
...
```
vendor/bin/phpunit tests/integration/Espo/Modules/CustomAclLogicPoc
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/CustomAclLogicPoc`
* `site/tests/integration/Espo/Modules/CustomAclLogicPoc`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/CustomAclLogicPoc/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/CustomAclLogicPoc/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/custom-acl-logic-poc/lib/init.js"
        ]
    }
    ```
